...
Since the notebook compute will only be used for quick testing and for submitting jobs to the cluster, we can use the default settings
(for example, CPU: 2 cores; RAM: 4 GB; Workspace volume: 10 GB; GPUs: none).
